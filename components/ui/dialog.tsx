...
/**
 * The form-carrying sibling of alert-dialog: same surface, but it scrolls and
 * it can be dismissed. An alert dialog asks one question and takes an answer;
 * this one holds a card with a dozen fields on it, which on a phone is taller
 * than the screen — hence `max-h` and the overflow rather than a fixed height.
 */
